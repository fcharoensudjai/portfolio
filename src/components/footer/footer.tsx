                ...
                <div className="flex flex-col justify-between space-y-[1rem] h-full">
                    ...
                    <div>
                        <ul className="flex-col space-y-1">
                            <li>
                                <UnderlinedLink isExternal={true} href="https://www.linkedin.com/in/fasaich/">
                                    linkedin
                                </UnderlinedLink>
                            </li>
                            <li>
                                <UnderlinedLink isExternal={true} href="https://www.instagram.com/fuzz_ch/">
                                    instagram
                                </UnderlinedLink>
                            </li>
                            <li>
                                <UnderlinedLink isExternal={true} href="https://www.artstation.com/fuzz_ch">
                                    artstation
                                </UnderlinedLink>
                            </li>
                            <li>
                                <UnderlinedLink isExternal={true} href="https://www.youtube.com/@fuzz_ch">
                                    youtube
                                </UnderlinedLink>
                            </li>
                        </ul>
