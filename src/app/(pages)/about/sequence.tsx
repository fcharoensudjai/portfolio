  ...
  return (
    <section className={`relative w-full ${bgClass} z-10 px-0 mb-32`} aria-label="Who am I sequence">
      <div className="flex flex-col xl:flex-row w-full justify-between">
        ...
        <div className="hidden xl:flex flex-col justify-center xl:pr-6 2xl:pr-12 min-w-[280px] sticky top-0 h-[100vh] py-[15vh]">
          ...
          <div className="flex flex-col gap-5 w-full mt-auto mb-auto">
            {aboutSequenceItems.map((item, index) => {
              ...
              const hoverClass = theme === "dark" ? "group-hover:text-text-dark" : "group-hover:text-black";
              return (
                <div key={item.id} className="relative group whitespace-nowrap">
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute -left-9 top-0 bottom-0 my-auto w-[32px] h-[32px] text-current"
                    >
                      <Image
                        src={
                          theme === "dark" ? `${basePath}/icons/dark/logodark.svg` : `${basePath}/icons/light/logo.svg`
                        }
                  ...
                  <div
                    className={`lowercase transition-colors duration-[350ms] ease-in-out ${isActive ? activeColorClass : `${inactiveClass} ${hoverClass}`}`}
                  >
                    <UnderlinedLink
        ...
        <div className="w-full xl:flex-1 flex flex-col justify-end pt-4 xl:pt-0 xl:pl-8 2xl:pl-16">
