              ...
              <div className="hidden lg:block lg:w-[55%] h-auto space-y-5">
                ...
                <div className="lg:sticky lg:top-0 lg:pt-[10.5dvh] lg:min-h-[100dvh] flex items-center justify-center">
                  ...
                  >
                    <Textbox>
                      <Scramble>
                        Art has always been a part of my life, and even though university keeps me busy, I still find
                        time to draw pieces inspired by the games and shows I love, like League of Legends, Genshin
                        Impact, and Arcane. I primarily work digitally using Procreate on my iPad, but I’ve also
                        explored traditional mediums in the past. My creative process is mostly focused on stylistic
