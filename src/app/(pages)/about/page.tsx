            ...
            <Fader enterDelay={1.2} once={true}>
                <div className="min-h-[100dvh] flex flex-col justify-between items-center px-6 md:px-16 xl:px-20">
                    <div className="flex flex-col flex-grow justify-center items-center text-center lg:max-w-[1500px] mt-[75.58px] xl:mt-[103.22px]">
                        <div>
                            <Title size="about">
                                Economics student with a passion for finance and data science finding a creative outlet,
                                dedicated to bringing ideas to life through vibrant and dynamic
                            </Title>
                        ...
                        <div className="hidden lg:block lg:w-[55%] h-auto space-y-5">
                                ...
                                >
                                    <Textbox>
                                        <Scramble>
                                            ...
                                            University of Warwick from Thailand. While I’m actively pursuing a career in
                                            consulting with a focus on data science and finance, my real passion is art.
                                            This website is a passion project I created over the summer, combining my
                                            love for art and web development to showcase my illustrations, concept art,
                                            and fanart in a way that feels true to my personal style.
                                        </Scramble>
                                    </Textbox>
                                </div>
                            </div>
                            ...
                            <div className="lg:sticky lg:top-0 lg:pt-[10.5dvh] lg:min-h-[100dvh] flex items-center justify-center">
                                ...
                                >
                                    <Textbox>
                                        <Scramble>
                                            Art has always been a part of my life, and even though university keeps me
                                            busy, I still find time to draw pieces inspired by the games and shows I
                                            love, like League of Legends, Genshin Impact, and Arcane. I primarily work
