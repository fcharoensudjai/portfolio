        ...
        <div className="flex flex-col space-y-5 md:space-y-7 mt-[75.58px] xl:mt-[103.22px]">
          ...
          <div className="flex flex-col lg:justify-between lg:flex-row items-start space-y-7 lg:space-y-0 lg:space-x-16">
            ...
            <div className="hidden lg:block lg:w-[55%] h-auto space-y-5">
              <div className="lg:sticky lg:top-0 lg:pt-[10dvh] lg:min-h-[100dvh] flex items-center justify-center">
                <div
                ...
                >
                  <Textbox>
                    <Scramble>
                      Hi, I’m Fasai Charoensudjai, a 20-year-old Economics student at the University of Warwick from
                      Thailand. While I’m actively pursuing a career in consulting with a focus on data science and
                      finance, my real passion is art. This website is a passion project I created over the summer,
                      combining my love for art and web development to showcase my illustrations, concept art, and
              ...
              <div className="lg:sticky lg:top-0 lg:pt-[10.5dvh] lg:min-h-[100dvh] flex items-center justify-center">
                <div
                  className={`lg:h-[60dvh] flex justify-center items-center ${theme === "dark" ? "bg-text-light text-text-dark" : "bg-main-light text-text-light"}`}
                >
                  <Textbox>
                    <Scramble>
                      Art has always been a part of my life, and even though university keeps me busy, I still find time
                      to draw pieces inspired by the games and shows I love, like League of Legends, Genshin Impact, and
                      Arcane. I primarily work digitally using Procreate on my iPad, but I’ve also explored traditional
                      mediums in the past. My creative process is mostly focused on stylistic work, but I’m always
              ...
              <div className="lg:sticky lg:top-0 lg:pt-[12dvh] lg:min-h-[100dvh] flex items-center justify-center">
                <div
                ...
                >
                  <Textbox>
                    <Scramble>
                      Coming from Thailand, I wanted this website to reflect a bit of my cultural background, which is
                      why I designed the logo based on a traditional Thai pattern. This site is not only a space to
                      display my art but also a step forward in my web development journey!
                    </Scramble>
                  </Textbox>
                </div>
              </div>
            ...
            <div className="lg:hidden h-auto space-y-5">
              ...
              >
                <Textbox caret={false}>
                  <Scramble>
                    ...
                    Thailand. While I’m actively pursuing a career in consulting with a focus on data science and
                    finance, my real passion is art. This website is a passion project I created over the summer,
                    combining my love for art and web development to showcase my illustrations, concept art, and fanart
                    in a way that feels true to my personal style.
                  </Scramble>
                </Textbox>
              </div>
              ...
              >
                <Textbox caret={false}>
                  <Scramble>
                    ...
                    to draw pieces inspired by the games and shows I love, like League of Legends, Genshin Impact, and
                    Arcane. I primarily work digitally using Procreate on my iPad, but I’ve also explored traditional
                    mediums in the past. My creative process is mostly focused on stylistic work, but I’m always pushing
                    myself to improve.
                  </Scramble>
                </Textbox>
              </div>
              ...
              >
                <Textbox>
                  <Scramble>
                    Coming from Thailand, I wanted this website to reflect a bit of my cultural background, which is why
                    I designed the logo based on a traditional Thai pattern. This site is not only a space to display my
                    art but also a step forward in my web development journey!
                  </Scramble>
                </Textbox>
              </div>
            </div>
